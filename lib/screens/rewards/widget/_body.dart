  ...
  static const List<Map<String, dynamic>> _rewards = [
    {
      ...
      'points': 500,
      'imagePath': 'assets/pngs/club.png',
    },
    {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              // ─── Redeem Your Rewards ──────────────────────────────
              Text('Redeem Your Rewards', style: AppText.b1b?.w(6)),
...
class _EarnCard extends StatelessWidget {
  ...
  const _EarnCard({required this.label, required this.points});
    ...
    return Expanded(
      child: Container(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(label, style: AppText.l1?.w(4).cl(AppTheme.c.text.main!)),
            Space.yf(8),
            Text(points, style: AppText.h5?.w(4)),
          ],
        ),
      ),
    );
...
class _RewardTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        AppRoutes.rewardsdetail.push(context);
      },
      child: Container(
        padding: Space.all(7),
        decoration: BoxDecoration(
